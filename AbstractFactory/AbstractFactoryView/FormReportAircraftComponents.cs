...
{
    public partial class FormReportAircraftComponents : Form
    {
        [Dependency]
        public new IUnityContainer Container { get; set; }
        private readonly ReportLogic logic;
        public FormReportAircraftComponents(ReportLogic logic)
        {
            InitializeComponent();
            this.logic = logic;
        }

        private void FormReportAircraftComponents_Load(object sender, EventArgs e)
        {
            try
            {
